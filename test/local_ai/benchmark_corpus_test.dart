...
void main() {
  group('AI Quality Evaluation Corpus & Scorecard (BRD §20)', () {
    ...
    final corpus = <BenchmarkCorpusEntry>[
      ...
      BenchmarkCorpusEntry(
        id: 'TC-09',
        category: BenchmarkCategory.absoluteDate,
        input: 'Pay rent on the 1st',
        expectedDraftCount: 1,
        expectedTitles: ['Pay rent'],
        expectedDueAt: DateTime(2026, 9, 1, 9, 0),
      ),
      BenchmarkCorpusEntry(
        id: 'TC-10',
        category: BenchmarkCategory.relativeDate,
        input: 'Call the bank this afternoon',
        expectedDraftCount: 1,
        expectedTitles: ['Call the bank'],
        expectedDueAt: DateTime(2026, 8, 10, 15, 0),
      ),
      BenchmarkCorpusEntry(
        id: 'TC-11',
        category: BenchmarkCategory.relativeDate,
        input: 'Write blog post next monday morning',
        expectedDraftCount: 1,
        expectedTitles: ['Write blog post'],
        expectedDueAt: DateTime(2026, 8, 17, 9, 0),
      ),
      BenchmarkCorpusEntry(
        id: 'TC-12',
        category: BenchmarkCategory.recurrence,
        input: 'Yoga every tuesday and thursday at 6pm',
        expectedDraftCount: 1,
        expectedTitles: ['Yoga'],
        expectedDueAt: DateTime(2026, 8, 11, 18, 0),
      ),
      BenchmarkCorpusEntry(
        id: 'TC-13',
        category: BenchmarkCategory.relativeDate,
        input: 'Tomorrow at 9 remind me to call David about the website',
        expectedDraftCount: 1,
        expectedTitles: ['Call David about the website'],
        expectedDueAt: DateTime(2026, 8, 11, 9, 0),
      ),
      BenchmarkCorpusEntry(
        id: 'TC-14',
        ...
        expectedDraftCount: 1,
        expectedTitles: ['Call mom'],
        expectedDueAt: DateTime(2026, 8, 10, 16, 30),
      ),
      BenchmarkCorpusEntry(
        id: 'TC-15',
        category: BenchmarkCategory.absoluteDate,
        input: 'Doctor on 25 August at 10:15',
        expectedDraftCount: 1,
        expectedTitles: ['Doctor'],
        expectedDueAt: DateTime(2026, 8, 25, 10, 15),
      ),
      BenchmarkCorpusEntry(
        id: 'TC-16',
        category: BenchmarkCategory.absoluteDate,
        input: 'Pay electricity bill 15/9',
        expectedDraftCount: 1,
        expectedTitles: ['Pay electricity bill'],
        expectedDueAt: DateTime(2026, 9, 15, 9, 0),
      ),
      BenchmarkCorpusEntry(
        id: 'TC-17',
        category: BenchmarkCategory.multiTask,
        input: 'Email John and call Lisa tomorrow at 10',
        expectedDraftCount: 2,
        expectedTitles: ['Email John', 'Call Lisa'],
        expectedDueAt: DateTime(2026, 8, 11, 10, 0),
      ),
      BenchmarkCorpusEntry(
        id: 'TC-18',
        category: BenchmarkCategory.multiTask,
        ...
        expectedDraftCount: 1,
        expectedTitles: ['Buy eggs, milk and bread'],
      ),
      BenchmarkCorpusEntry(
        id: 'TC-19',
        category: BenchmarkCategory.priorityTags,
        input: 'Birthday party on Saturday at 7pm #family',
        expectedDraftCount: 1,
        expectedTitles: ['Birthday party'],
        expectedDueAt: DateTime(2026, 8, 15, 19, 0),
        expectedTags: ['family'],
      ),
      BenchmarkCorpusEntry(
        id: 'TC-20',
        category: BenchmarkCategory.edgeCases,
        input: 'call dentist tmrw 9am',
        expectedDraftCount: 1,
        expectedTitles: ['Call dentist'],
        expectedDueAt: DateTime(2026, 8, 11, 9, 0),
      ),
    ];
